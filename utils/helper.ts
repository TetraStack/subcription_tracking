...
export function calculateMonthlyExpense(subscriptions: Subscriptions[]): number {
    let total = 0;
...
export function getNextDueDate(subscription_date: string, subscription_type: string) {
